...
export default function EnquiryForm() {
  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      setBanner({
        kind: "success",
        msg: "Thank you! Our team will contact you shortly.",
      });
    ...
    <section id="enquiry" className="bg-white">
      <div className="container py-16">
        ...
        <p className="mt-2 text-gray-600">
          Tell us what you need. We'll share a tailored quote.
        </p>

        {banner && (
          <div
            className={`mt-4 rounded-xl px-4 py-3 text-sm text-white ${
              banner.kind === "success" ? "bg-green-600" : "bg-red-600"
            }`}
          >
            {banner.msg}
          </div>
        ...
        <form onSubmit={onSubmit} className="mt-6 grid gap-8 md:grid-cols-2">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="col-span-2">
                ...
                <textarea
                  rows="4"
                  className="mt-1 w-full rounded-xl border p-2"
                  placeholder="Any specs or links…"
                  value={form.notes}
          ...
          <div className="card p-4">
            ...
            <div className="mt-3 rounded-xl border p-3 text-sm">
              ...
              {form.notes && (
                <div className="mt-2 text-gray-800">{form.notes}</div>
              )}
            </div>
          </div>
        </form>
